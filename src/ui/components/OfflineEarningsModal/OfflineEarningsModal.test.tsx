...
describe('OfflineEarningsModal', () => {
  it('muestra el desglose: cobro formateado y tiempo fuera (GDD §7)', () => {
    render(<OfflineEarningsModal earned={12_500} elapsedMs={3 * 3_600_000 + 24 * 60_000} onClose={() => {}} />)
  ...
  it('el botón "Recoger" cierra el modal', () => {
    const onClose = vi.fn()
    render(<OfflineEarningsModal earned={5} elapsedMs={60_000} onClose={onClose} />)
